...
export type FeathermissAccountUnlinkResponse = operations['feathermiss___account___unlink']['responses']['200']['content']['application/json'];
export type FeathermissAdminConfigGetResponse = operations['feathermiss___admin___config___get']['responses']['200']['content']['application/json'];
export type FeathermissAdminConfigSetRequest = operations['feathermiss___admin___config___set']['requestBody']['content']['application/json'];
export type FeathermissAdminConfigSetResponse = operations['feathermiss___admin___config___set']['responses']['200']['content']['application/json'];
export type FeathermissAdminProviderGetResponse = operations['feathermiss___admin___provider___get']['responses']['200']['content']['application/json'];
export type FeathermissAdminProviderSetRequest = operations['feathermiss___admin___provider___set']['requestBody']['content']['application/json'];
export type FeathermissAdminProviderSetResponse = operations['feathermiss___admin___provider___set']['responses']['200']['content']['application/json'];
export type FeathermissAdminPurgeRequest = operations['feathermiss___admin___purge']['requestBody']['content']['application/json'];
export type FeathermissAdminPurgeResponse = operations['feathermiss___admin___purge']['responses']['200']['content']['application/json'];
export type FeathermissNotesTranslateRequest = operations['feathermiss___notes___translate']['requestBody']['content']['application/json'];
export type FeathermissNotesTranslateResponse = operations['feathermiss___notes___translate']['responses']['200']['content']['application/json'];
export type FeathermissNotesTranslateEnqueueRequest = operations['feathermiss___notes___translate___enqueue']['requestBody']['content']['application/json'];
export type FeathermissNotesTranslateEnqueueResponse = operations['feathermiss___notes___translate___enqueue']['responses']['200']['content']['application/json'];
export type FeathermissPreferencesGetResponse = operations['feathermiss___preferences___get']['responses']['200']['content']['application/json'];
export type FeathermissPreferencesSetRequest = operations['feathermiss___preferences___set']['requestBody']['content']['application/json'];
export type FeathermissPreferencesSetResponse = operations['feathermiss___preferences___set']['responses']['200']['content']['application/json'];
